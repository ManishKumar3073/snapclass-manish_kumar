...
# username unique check function
# function for register -> if pressed register now
# one for Login
...
def unenroll_student_to_subject(student_id,subject_id):
    response=supabase.table('subject_student').delete().eq('subject_id',subject_id).eq('subject_id',subject_id).execute()
    return response.data
